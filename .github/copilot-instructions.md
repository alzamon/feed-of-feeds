...
This project **must work on both Termux and Ubuntu** environments. When making changes, always consider compatibility with both platforms:
...
When implementing features or fixing bugs, always verify that changes work correctly on both Termux and Ubuntu environments.
